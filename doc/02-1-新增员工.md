...
![image-20221111161120975-zoom: 50%;](assets/image-20221111161120975.png)
...
![image-20221111162912753-zoom:50%;](assets/image-20221111162912753.png) ![image-20221111162930483-zoom:50%;](assets/image-20221111162930483.png)
...
![image-20221111164002448-zoom:50%;](assets/image-20221111164002448.png)

**思考：**是否可以使用对应的实体类来接收呢？

![image-20221111164453341-zoom:50%;](assets/image-20221111164453341.png)
...
![image-20221111184934153-zoom:50%;](assets/image-20221111184934153.png)
...
![image-20221111185649636-zoom: 50%;](assets/image-20221111185649636.png)
...
![image-20221111185901726-zoom: 50%;](assets/image-20221111185901726.png)

**接口测试：**

![image-20221111190132481-zoom:50%;](assets/image-20221111190132481.png)

其中，请求头部含有JWT令牌

![image-20221111190248268-zoom:50%;](assets/image-20221111190248268.png)
...
![image-20221111192339271-zoom:50%;](assets/image-20221111192339271.png)
...
![image-20221111193700895-zoom: 50%;](assets/image-20221111193700895.png)

后台报错信息：

![image-20221111194049620-zoom:80%;](assets/image-20221111194049620.png)

查看employee表结构：

![image-20221111194131787-zoom:50%;](assets/image-20221111194131787.png)
...
![image-20221111195521095-zoom:50%;](assets/image-20221111195521095.png)
...
![image-20221111201922482-zoom:50%;](assets/image-20221111201922482.png)
...
![image-20221111212349365-zoom:67%;](assets/image-20221111212349365.png)
...
![image-20221111214044510-zoom:50%;](assets/image-20221111214044510.png)

查看employee表记录

![image-20221111214354053-zoom:50%;](assets/image-20221111214354053.png)

## 1.5 代码提交

点击提交：

![image-20221112092139583-zoom: 50%;](assets/image-20221112092139583.png)

提交过程中，出现提示：

![image-20221112092239578-zoom:50%;](assets/image-20221112092239578.png)

继续push:

![image-20221112092332837-zoom:50%;](assets/image-20221112092332837.png)

推送成功：

![image-20221112092427252-zoom: 80%;](assets/image-20221112092427252.png)
